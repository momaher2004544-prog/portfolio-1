...
export default function Footer() {
  return (
    <footer className="py-6 px-4 md:px-8 lg:px-12 border-t border-white/5">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-gray-500 font-mono">
